...
# 状态栏
status = tk.Label(top, textvariable=var_status,bd=2, relief=tk.SUNKEN, anchor=tk.W)
status.pack(side=tk.BOTTOM, fill=tk.X)

var_line = tk.StringVar()
# 行数
line_label = tk.Label(top, width=2, bg='antique white', textvariable=var_line, anchor=tk.N, font=10)
line_label.pack(side=tk.LEFT, fill=tk.Y)

# 文本编辑区域
textPad = tk.Text(top, undo=True,font=18)
